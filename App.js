  ...
  return (
    <>
      ...
      <SafeAreaView>
        ...
        { currentScreen === 'messages' ? <ChatRoom Auth={auth} CurrentLocation={currentLocation} getLocation={getLocation} updateScreen={updateScreen} RoomCode={roomCode} RoomUsers={roomUsers} Messages={roomMessages} /> : null }
      </SafeAreaView>
    </>
  );
};
